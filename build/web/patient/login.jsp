  ...
  <div class="auth-main">
    <div class="auth-wrapper v3">
      <div class="auth-form">
        ...
        <div class="card my-5">
          <div class="card-body">
            <form method="post" action="/hospital/plogin">
              <div class="mb-4 d-flex justify-content-between align-items-end">
                <h3 class="mb-0"><b>Patient Login</b></h3>
              ...
              <div class="form-group mb-3">
                ...
                <input type="name" name="name" class="form-control" placeholder="Enter username" required>
              </div>
              ...
              <br><center>
                  <a href="register.jsp" class="btn btn-primary">New Register</a></center>
            </form>
