  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      ...
      <ul class="pc-navbar" >
        ...
        <li class="pc-item">
          <a href="viewappoi.jsp" class="pc-link">
            <span class="pc-micon"><i class="ti ti-typography"></i></span>
            <span class="pc-mtext">view Appointments</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="history.jsp" class="pc-link">
            <span class="pc-micon"><i class="ti ti-stethoscope"></i></span>
            <span class="pc-mtext">view history</span>
          </a>
        </li>
        <li class="pc-item">
        ...
        <li class="pc-item">
          <a href="changepass.jsp" class="pc-link">
