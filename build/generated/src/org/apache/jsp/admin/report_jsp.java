...
public final class report_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("          <a href=\"#!\" class=\"pc-link\"><span class=\"pc-micon\"><i class=\"ti ti-menu\"></i></span><span class=\"pc-mtext\">Report\n");
      out.write("              </span><span class=\"pc-arrow\"><i data-feather=\"chevron-right\"></i></span></a>\n");
      out.write("          <ul class=\"pc-submenu\">\n");
      out.write("            <li class=\"pc-item\"><a class=\"pc-link\" href=\"#!\">Daily Appointments</a></li>\n");
      out.write("            <li class=\"pc-item pc-hasmenu\">\n");
      out.write("              <a href=\"#!\" class=\"pc-link\">Weekly Appointments<span class=\"pc-arrow\"><i data-feather=\"chevron-right\"></i></span></a>\n");
      out.write("              <ul class=\"pc-submenu\">\n");
    ...
    try {
      ...
      out.write("</h4>\n");
      out.write("            <button class=\"btn btn-primary btn-sm\" onclick=\"showDoctors()\">View</button>\n");
      out.write("          </div>\n");
      out.write("        </div>\n");
      out.write("      </div>\n");
      out.write("      <div class=\"col-md-3 mb-3\">\n");
      ...
      out.write("</h4>\n");
      out.write("            <button class=\"btn btn-primary btn-sm\" onclick=\"showPatients()\">View</button>\n");
      out.write("          </div>\n");
      out.write("        </div>\n");
      out.write("      </div>\n");
      out.write("      <div class=\"col-md-3 mb-3\">\n");
      ...
      out.write("</h4>\n");
      out.write("            <button class=\"btn btn-primary btn-sm\" onclick=\"showAppointments()\">View</button>\n");
      out.write("          </div>\n");
      out.write("        </div>\n");
      out.write("      </div>\n");
      out.write("      <div class=\"col-md-3 mb-3\">\n");
      ...
      out.write("</h4>\n");
      out.write("            <button class=\"btn btn-primary btn-sm\" onclick=\"showTodayAppointments()\">View</button>\n");
      out.write("          </div>\n");
      out.write("        </div>\n");
      out.write("      </div>\n");
      out.write("    </div>\n");
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("  // Helper for escaping JSP text into JavaScript safely\n");
      out.write("  function esc(str) {\n");
      out.write("    return str.replace(/\\\\/g, \"\\\\\\\\\").replace(/\"/g, '\\\\\"').replace(/\\n/g, \" \").replace(/\\r/g, \"\");\n");
      out.write("  }\n");
      out.write("\n");
 ...
 for (int i = 0; i < doctorList.size(); i++) { String n = doctorList.get(i); 
      out.write("\n");
      out.write("      \"");
      out.print( n.replace("\\","\\\\").replace("\"","\\\"").replace("\n"," ").replace("\r","") );
      out.write('"');
 ...
 for (int i = 0; i < list.size(); i++) { 
      ...
      out.print( item );
      out.write('"');
      out.print( (i < list.size() - 1) ? "," : "" );
      out.write("\n");
      out.write("        ");
 } 
      out.write("\n");
      out.write("      ]");
      out.print( (++c < doctorMonthlyDetails.size()) ? "," : "" );
      out.write("\n");
      out.write("    ");
 } 
      out.write("\n");
 ...
 for (int i = 0; i < list.size(); i++) { 
      ...
      out.write("\n");
      out.write("      ]");
      out.print( (++c < doctorDailyDetails.size()) ? "," : "" );
      out.write("\n");
      out.write("    ");
 } 
      out.write("\n");
 ...
 c = 0; for (Map.Entry<String,Integer> e : doctorMonthlyAppointments.entrySet()) { 
      ...
      out.print( (++c < doctorMonthlyAppointments.size()) ? "," : "" );
      out.write("\n");
      out.write("    ");
 } 
      out.write("\n");
 ...
 c = 0; for (Map.Entry<String,Integer> e : doctorDailyAppointments.entrySet()) { 
      ...
      out.write("\": ");
      out.print( e.getValue() );
      out.print( (++c < doctorDailyAppointments.size()) ? "," : "" );
      out.write("\n");
      out.write("    ");
 } 
      out.write("\n");
      ...
      out.write("    let html = \"<h5>Doctors List</h5><ul>\";\n");
      out.write("    doctorList.forEach(doc => {\n");
      out.write("      html += \"<li><b>\" + doc + \"</b> - Daily: \" + (doctorDaily[doc] || 0) +\n");
      out.write("        \" <button class='btn btn-link p-0' onclick=\\\"showDailyDetails('\" + doc + \"')\\\">Details</button>, \" +\n");
      out.write("        \"Monthly: \" + (doctorMonthly[doc] || 0) +\n");
      out.write("        \" <button class='btn btn-link p-0' onclick=\\\"showMonthlyDetails('\" + doc + \"')\\\">Details</button></li>\";\n");
      out.write("    });\n");
      out.write("    html += \"</ul>\";\n");
      ...
      out.write("    document.getElementById(\"detailSection\").innerHTML = \"<h5>Total Patients</h5><p>");
      out.print( totalPatients );
      out.write(" patients registered.</p>\";\n");
      out.write("  }\n");
      out.write("\n");
      out.write(" function showAppointments() {\n");
      out.write("    let list = monthlyFull;   // full monthly appointment details (already generated from JSP)\n");
      out.write("\n");
      out.write("    let html = \"<h5>Appointments (Last 30 Days ? Full Details)</h5>\";\n");
      out.write("\n");
      out.write("    if (list.length === 0) {\n");
      out.write("        html += \"<p>No appointments found.</p>\";\n");
      out.write("    } else {\n");
      out.write("        html += \"<ul>\";\n");
      out.write("        list.forEach(item => {\n");
      out.write("            html += \"<li>\" + item + \"</li>\";\n");
      out.write("        });\n");
      out.write("        html += \"</ul>\";\n");
      out.write("    }\n");
      out.write("\n");
      ...
      out.write("    let html = \"<h5>Today's Appointments</h5><ul>\";\n");
      out.write("    for (let doc in doctorDaily) {\n");
      out.write("      html += `<li>");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${doc}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(':');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${doctorDaily[doc]}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(" \n");
      out.write("        <button class='btn btn-link p-0' onclick=\"showDailyDetails('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${doc}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("')\">Details</button></li>`;\n");
      out.write("    }\n");
      out.write("    html += \"</ul>\";\n");
      out.write("    document.getElementById(\"detailSection\").innerHTML = html;\n");
      out.write("  }\n");
      ...
      out.write("    let list = doctorMonthlyDetails[doc] || [];\n");
      out.write("    let html = `<h5>Monthly Appointments for ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${doc}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("</h5>`;\n");
      out.write("    if (list.length === 0) html += \"<p>No appointments found.</p>\";\n");
      out.write("    else html += \"<ul>\" + list.map(item => `<li>");
      ...
      out.write("</li>`).join(\"\") + \"</ul>\";\n");
      out.write("    document.getElementById(\"detailSection\").innerHTML = html;\n");
      out.write("  }\n");
      out.write("\n");
      out.write("  function showDailyDetails(doc) {\n");
      out.write("    let list = doctorDailyDetails[doc] || [];\n");
      out.write("    let html = `<h5>Today's Appointments for ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${doc}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("</h5>`;\n");
      out.write("    if (list.length === 0) html += \"<p>No appointments found.</p>\";\n");
      out.write("    else html += \"<ul>\" + list.map(item => `<li>");
      ...
      out.write("  }\n");
      out.write("</script>\n");
      out.write("here i attached the output page photo in that in that \n");
      out.write("when i click first details button it should display the doctor's registration information\n");
      out.write("change the code into this\n");
      out.write("\n");
    } catch (Throwable t) {
