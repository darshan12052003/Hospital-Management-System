...
public final class patientsreeport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("              <a href=\"#!\" class=\"pc-link\"> Appointments<span class=\"pc-arrow\"><i data-feather=\"chevron-right\"></i></span></a>\n");
      out.write("              <ul class=\"pc-submenu\">\n");
    ...
    if (pid == null || pid.trim().equals("")) {
        out.println("<h3 style='color:red;'>Error: Missing patient_id in URL.</h3>");
        return;
    }
    ...
    try {
        ...
        // Patient details
        ps1 = con.prepareStatement("SELECT * FROM patients WHERE id=?");
        ps1.setInt(1, id);
        rs1 = ps1.executeQuery();

        // Consultations
        ps2 = con.prepareStatement(
            "SELECT a.id AS app_id, d.doctorname, a.created_at " +
            "FROM appointment a " +
        ...
        ps3 = con.prepareStatement(
            "SELECT COUNT(*) AS visit_count FROM appointment WHERE patient_id=?"
        );
        ps3.setInt(1, id);
      ...
      out.write("        <hr>\n");
      out.write("\n");
      out.write("        <h4><b>Patient Details</b></h4>\n");
      ...
      out.write("</td></tr>\n");
      out.write("            <tr><th>Created At</th><td>");
      out.print( rs1.getString("created_at") );
      out.write("</td></tr>\n");
      out.write("        ");
      ...
      out.write("\n");
      out.write("            <tr><td colspan=\"2\" style=\"color:red;\">Patient not found.</td></tr>\n");
      out.write("        ");
      ...
      out.write("        </table>\n");
      out.write("\n");
      out.write("        <!-- Total Visits -->\n");
      out.write("        <h4><b>Total Visits</b></h4>\n");
      out.write("        ");

            int visits = 0;
            if (rs3.next()) visits = rs3.getInt("visit_count");
        
      out.write("\n");
      out.write("        <p><b>Visited hospital:</b> ");
      out.print( visits );
      out.write(" times</p>\n");
      out.write("\n");
      out.write("        <!-- Appointments -->\n");
      out.write("        <h4><b>Doctor Consultations</b></h4>\n");
      out.write("        <table class=\"table table-bordered\">\n");
      out.write("            <tr>\n");
      out.write("                <th>Appointment ID</th>\n");
      out.write("                <th>Doctor Name</th>\n");
      out.write("                <th>Visited On</th>\n");
      out.write("            </tr>\n");
      out.write("            ");
      ...
      out.write("        </table>\n");
      out.write("\n");
      out.write("        <h4><b>Prescriptions</b></h4>\n");
      out.write("        <p><i>(Add your prescription query here)</i></p>\n");
      out.write("\n");
      out.write("    </div>\n");
      out.write("</div>\n");
      out.write("\n");
