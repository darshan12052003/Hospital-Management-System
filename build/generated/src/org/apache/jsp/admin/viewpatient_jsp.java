...
public final class viewpatient_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("<head>\n");
      out.write("  <title>Care Point-Hospital Management System</title>\n");
      out.write("  <!-- [Meta] -->\n");
      ...
      out.write("        <img src=\"../assets/images/logo-icon.svg\" class=\"img-fluid logo-lg\" style=\"width:140px;\" alt=\"Care Point Logo\">\n");
      out.write("\n");
      out.write("      </a>\n");
      out.write("    </div>\n");
      ...
      out.write("    <div class=\"card shadow-sm p-4\">\n");
    ...
    if(idParam != null && !idParam.isEmpty()) {
        try {
            ...
            PreparedStatement ps = con.prepareStatement("SELECT * FROM appointmentss WHERE id = ?");
            ps.setInt(1, id);
            ...
            if(rs.next()) {
                ...
                int age = rs.getInt("age"); // make sure you have an 'age' column
                String reason = rs.getString("reason"); // make sure you have a 'reason' column
                String prescription = rs.getString("prescription"); // make sure you have a 'prescription' column
      ...
      out.write("/appointments.jsp\" class=\"btn btn-primary mt-3\">Back to Appointments</a>\n");
      out.write("\n");

            } else {

      out.write("\n");
      out.write("        <div class=\"alert alert-warning\">Patient not found.</div>\n");
      ...
      out.write("\n");
      out.write("        <div class=\"alert alert-warning\">Invalid Patient ID.</div>\n");
